...
public class ValidationClass {
    ...
    public static boolean validationAddOrder(MainScreenSidebarAddOrderClass mainScreenSidebarAddOrderClass, String restaurant, String order) throws InterruptedException {
    ...
    public static boolean validationRestaurant(MainScreenSidebarAddOrderClass mainScreenSidebarAddOrderClass) throws InterruptedException {
        ...
        for(int i=0;i<listValidationRestaurant.size();i++){
            mainScreenSidebarAddOrderClass.getRestaurantName().sendKeys(listValidationRestaurant.get(i).value);
            Thread.sleep(700);
            if(mainScreenSidebarAddOrderClass.getSubmitButton().isEnabled() && listValidationRestaurant.get(i).key == false || !mainScreenSidebarAddOrderClass.getSubmitButton().isEnabled() && listValidationRestaurant.get(i).key == true){
                return false;
            }
            while(!mainScreenSidebarAddOrderClass.getRestaurantName().getAttribute("value").isEmpty()){
                mainScreenSidebarAddOrderClass.getRestaurantName() .sendKeys(Keys.BACK_SPACE);
    ...
    public static boolean validationAddAddress(MainScreenSidebarAddAddressClass mainScreenSidebarAddAddressClass, String city, String address, String home) throws InterruptedException {
        ...
        for(int i=0;i<listValidationAddAddress.size();i++){
            ...
            mainScreenSidebarAddAddressClass.getName().sendKeys(listValidationAddAddress.get(i).name);
            //TODO: Переделать sleep! говно!
            Thread.sleep(700);
