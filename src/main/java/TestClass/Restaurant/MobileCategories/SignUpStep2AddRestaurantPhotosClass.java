 ...
 */
public class SignUpStep2AddRestaurantPhotosClass {

    WebDriver driver;
    WebDriverWait waiting;

    public SignUpStep2AddRestaurantPhotosClass(WebDriver driver){
        this.driver = driver;
    }
    ...
    String pathAndroid = "//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]" +
            "/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.support.v4.view.ViewPager[1]/android.widget.RelativeLayout[1]" +
            "/android.support.v7.widget.RecyclerView[1]";
    //android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.LinearLayout[1]/android.widget.FrameLayout[1]
    // /android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.support.v4.view.ViewPager[1]/android.widget.RelativeLayout[1]
    // /android.support.v7.widget.RecyclerView[1]/android.widget.LinearLayout[1]/android.widget.RelativeLayout[1]/android.widget.ImageButton[1]
    ...
    public void chooseDevice() throws InterruptedException {
        ...
        switch (GlobalMethods.chooseDevice()) {
            case "ios":
                waiting.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIANavigationBar[1]/UIAButton[3]")));
                setAddPictures(driver.findElement(By.xpath(pathIOS + "/UIAButton[1]")));
                setAddPicturesCorner(driver.findElement(By.xpath("//UIAApplication[1]/UIAWindow[1]/UIANavigationBar[1]/UIAButton[3]")));
                ...
                setSendButton(driver.findElement(By.name("Send")));
                break;
            case "android":
