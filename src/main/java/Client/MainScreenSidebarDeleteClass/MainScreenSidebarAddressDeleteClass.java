package Client.MainScreenSidebarDeleteClass;
 ...
 */
public class MainScreenSidebarAddressDeleteClass {

    WebDriver driver;
    WebDriverWait waiting;

    public MainScreenSidebarAddressDeleteClass(WebDriver driver){
        this.driver = driver;
    }
